                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="basic-datatable" class="table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                         @foreach($dslinhvuc_da_xoa as $linhvuc)
                                        <tr>
                                            ...
                                            <td>    
                                                ...
                                                <a href="{!! route('ds_linhvuc.ds_linhvuc.xulisua',$linhvuc->id) !!}"><i class=" mdi mdi-pencil-outline" style="font-size: 40px;"></i></a> 
                                                    ...
                                                    <form action="{!! route('ds_linhvuc.xoa',$linhvuc->id) !!}" method="POST">
                                                         @method('DELETE')
                                                      @csrf
                                                     <button class="btn btn-danger waves-effect waves-light" type="submit" onclick="confirm('Bạn có chắc muốn xóa?')"><i class="mdi mdi-close"></i></button>
                                                    </form>
